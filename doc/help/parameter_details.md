<center> <h1> Parameter Details </h1> </center>

## Details about model construction parameters
### Overview
...
- current version of this tool and its key dependent package.
...
This page provides many features related to datasets and the entry to "General Analysis". This section we will only focus on the former part, for "General Analysis", please refer to the next section.
...
After your selection, the tool will repond you selection to query the extra information.
...
1. "Download data directly" will download datasets from data hubs and zip the datasets to provides download by your browser.
...
Inspired by the browser, feature "genomic signature" is also supported in this tool. For most of analysis modules, this feature is deployed and work well.
