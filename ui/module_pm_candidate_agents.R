...
# set up with UI
ui.page_module_pm_candidate_agents <- function() {
  fluidPage(
      ...
      bs4Dash::bs4Card(
        ...
        fluidRow(
          ...
          column(
            ...
            selectInput(
              inputId = "PrognosticModelPageSubmoduleCandidateAgentsDatabaseSelection",
              width = "100%",
              label = NULL,
          ...
          column(
            ...
            span(
              shiny::actionButton(
                inputId = "PrognosticModelPageSubmoduleCandidateAgentsSubmitBtn",
                label = "Start",
                icon = icon("rocket"),
    ...
    div(
      ...
      htmlOutput(
        outputId = "PrognosticModelPageSubmoduleCandidateAgentsHeatmapHtml"
      ),
      ...
      span(
        shiny::downloadButton(
          outputId = "PrognosticModelPageSubmoduleCandidateAgentsHeatmapDownloadPdfBtn",
          label = "Download PDF",
          icon = icon("file-pdf-o"),
          style = "color:#FF6B6B;background-color:#ffffff;",
        ),
        shiny::downloadButton(
          outputId = "PrognosticModelPageSubmoduleCandidateAgentsHeatmapDownloadPngBtn",
          label = "Download PNG",
          icon = icon("file-image-o"),
          style = "color:#FF6B6B;background-color:#ffffff;",
        ),
        shiny::downloadButton(
          outputId = "PrognosticModelPageSubmoduleCandidateAgentsHeatmapDownloadTableBtn",
      ...
      fluidRow(
        ...
        column(
          3,
          selectInput(
            inputId = "PrognosticModelPageSubmoduleCandidateAgentsSubplotCorMethodSelection",
            width = "100%",
            label = NULL,
        ...
        column(
          3,
          shiny::actionButton(
            inputId = "PrognosticModelPageSubmoduleCandidateAgentsSubplotSubmitBtn",
            label = "Show Plot",
      ...
      plotOutput(
        outputId = "PrognosticModelPageSubmoduleCandidateAgentsSubplot",
        width = "350px",
        height = "400px"
      ),
      div(
        ...
        span(
          shiny::downloadButton(
            outputId = "PrognosticModelPageSubmoduleCandidateAgentsSubplotDownloadPdfBtn",
            label = "Download PDF",
            icon = icon("file-pdf-o"),
            style = "color:#FF6B6B;background-color:#ffffff;",
          ),
          shiny::downloadButton(
            outputId = "PrognosticModelPageSubmoduleCandidateAgentsSubplotDownloadPngBtn",
            label = "Download PNG",
            icon = icon("file-image-o"),
            style = "color:#FF6B6B;background-color:#ffffff;",
          )
